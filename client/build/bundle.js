...
/***/ function(module, exports, __webpack_require__) {
	...
	var ViewBox = __webpack_require__(159);
	
	window.onload = function () {
	  ReactDOM.render(React.createElement(ViewBox, null), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OutOfStock = __webpack_require__(163);
	var Total = __webpack_require__(164);
	var Voucher = __webpack_require__(165);
	...
	var ViewBox = React.createClass({
	  ...
	  addToCart: function addToCart(clicked) {
	    var addedItem = this.state.stock.filter(function (item) {
	      if (item.name === clicked) return item;
	    });
	  ...
	  updateStock: function updateStock(addedItem) {
	  ...
	  refreshStock: function refreshStock(removedItem) {
	  ...
	  voucherChecker: function voucherChecker(total) {
	  ...
	  fiveDiscount: function fiveDiscount(total) {
	    total -= 5;
	    return total;
	  },
	
	  tenDiscount: function tenDiscount(total) {
	    if (total > 50) {
	      total -= 10;
	      return total;
	    }
	  ...
	  fifteenDiscount: function fifteenDiscount(total) {
	  ...
	  applyVoucher: function applyVoucher(code) {
	  ...
	  setVoucher: function setVoucher(voucher) {
	    this.setState({
	      voucher: voucher
	    });
	  },
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(OutOfStock, {
...
/***/ function(module, exports) {
	...
	{
	  name: "Lightweight Patch Pocket Balzer, Deer",
	  category: "Men's Formalwear",
	  price: 175.00,
	  quantity: 1
	},
	    ...
	    var items = this.props.stock.map(function (item) {
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            "button",
	            { onClick: this.handleClick, value: item.name },
	            "Add to cart"
	          )
	        )
	      );
	...
	var Voucher = React.createClass({
	  ...
	  render: function render() {
	    ...
	    if (this.props.voucher === "invalid") {
	      voucher = React.createElement(
	        "h4",
	        { id: "invalid" },
	        "This is not a valid voucher please try again."
	      );
	    }
	    ...
	    if (this.props.cart.length > 0) {
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement("input", { id: "input", type: "text" }),
	          React.createElement("input", { type: "submit", value: "Apply Voucher" })
	        ),
	        voucher
	      );
	    }
